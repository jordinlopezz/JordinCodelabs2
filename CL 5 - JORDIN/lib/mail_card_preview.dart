...
import 'package:animations/animations.dart';  // Importa el paquete de animaciones
...
class MailPreviewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Uso de _OpenContainerWrapper en lugar de Material y InkWell
...
// Clase _OpenContainerWrapper para la transición de contenedores
